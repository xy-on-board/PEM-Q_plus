...
def DSB_filter(basename, yourfile):
    ...
    # filter prey MQ = 0
    mq0 = finalset[finalset['Prey_MQ'] == 0]
    use_r1 = mq0[mq0['annotation'] == 'R1']
    stitched = mq0[mq0['annotation'] == 'stitched']
    len_180 = stitched[stitched['Qlen'] >= 180]

    other = finalset[finalset['Prey_MQ'] > 0]
    finalset = pd.concat([use_r1, len_180, other])
