...
The definition of indel is the same as in PEM-Q. This script is identical to the one in PEM-Q.

Input file: indel alignment bam file / Output file: an informative file
...
class Define_indel(object):
    ...
    def generate_indel_tab_file(self):
        ...
        transloc = pd.concat([transloc, indel_transloc_cutoff], ignore_index=True)
        ...
        #ALL Insertions
        all_insertion = pd.concat([Insertion, Insertion_sv], ignore_index=True)
