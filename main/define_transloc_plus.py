...
Reads are classified into chimeric reads, indel reads, and germline reads. An informative file of latent translocations will be generated.
...
class Define_transloc(object):
    ...
    def align_chimeric_nosti_R2(self):
        ...
        cmd = "bwa mem -Y -t 8 {} {} > {}".format(bwa_index_path, nosti_R2_chimeric, self.nosti_R2_chimeric_sam)
        os.system(cmd)
